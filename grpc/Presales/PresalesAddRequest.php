...
/**
 * Generated from protobuf message <code>Presales.PresalesAddRequest</code>
 */
class PresalesAddRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $adminid = '';
    /**
     * Generated from protobuf field <code>repeated .Presales.PresalesAddData data = 8;</code>
     */
    private $data;
     ...
     *     @type string $email
     *     @type string $adminid
     *     @type array<\Presales\PresalesAddData>|\Google\Protobuf\Internal\RepeatedField $data
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Presales.PresalesAddData data = 8;</code>
     * @param array<\Presales\PresalesAddData>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setData($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Presales\PresalesAddData::class);
        $this->data = $arr;
