document.addEventListener("DOMContentLoaded", function () {
    ...
    sendverifbutton.addEventListener("click", function(e) {
        ...
        xhr.open("POST", "/sendverifyphone", false);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                if (xhr.status == 200) {
                    ...
                    sendinfo.innerHTML = "Success send verification code. Please check your Whatsapp. You can resend the code after 30 seconds."
                    setTimeout(() => {
    ...
    button.addEventListener('click', function(e) {
        ...
        xhr.open("POST", "/doverifyphone", false);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                if (xhr.status == 200) {
                    sendinfo.classList.remove('d-none')
                    sendalert.classList.add('d-none')
                    sendinfo.innerHTML = "Success verify OTP, you will be redirected to dashboard in 5 seconds."
                    setTimeout(() => {
